...
> 科研绘图配色方案库 —— 28 套经过精心调校的学术图表配色，覆盖东方美学、中国传统色、顶级期刊、色盲友好、连续/发散色板。

![Python](https://img.shields.io/badge/Python-3.7+-blue.svg)
![License](https://img.shields.io/badge/License-MIT-green.svg)
![Palettes](https://img.shields.io/badge/Palettes-28-purple.svg)
...
灵感源自中华传统色 742 色体系，按文化主题精选。

| 色板 | 色值 | 灵感来源 | 适用 |
|------|------|----------|------|
| **青绿山水** | `#134857` `#6C9BCA` `#AED9D4` `#C6E3E1` `#E8F4F0` | 千里江山图 | 地理、环境、梯度数据 |
| **故宫印象** | `#2E292B` `#652B1C` `#D4A017` `#6C9BCA` `#FFF8E7` | 红墙黄瓦 | 人文社科、文化遗产 |
| **水墨丹青** | `#2E292B` `#474B4C` `#9C9CA4` `#B5AA90` `#F8F4E9` | 焦浓重淡清 | 黑白打印、方法示意图 |
| **敦煌壁画** | `#8B4513` `#D4A017` `#3B7A57` `#134857` `#7E2065` | 矿物颜料 | 考古、材料分析 |
| **江南烟雨** | `#EEF7F2` `#C6E3E1` `#AED9D4` `#EDC3AE` `#E9CCD3` | 水乡烟雨 | 生态、水文、食品 |
| **花朝月夜** | `#F9F4DC` `#EDC3AE` `#E16C96` `#7E1671` `#6C9BCA` | 魏紫初荷 | 植物学、药学 |
